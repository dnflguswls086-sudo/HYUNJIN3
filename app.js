...
function openUI(){const o=openNow();$("closed").classList.toggle("hidden",o);if(!o)$("closed").textContent="현재는 학생 운영 시간이 아닙니다. 금요일 11:00~22:00, 토·일 09:00~20:00에 이용할 수 있어요.";updateGo();if(!o&&!$("board").classList.contains("hidden")&&!teacherMode){view("landing");toast("학생 운영시간이 종료되었어요.")}}
